...
function Surface({ children }) {
  return (
    <div className="h-full min-h-0 min-w-0 overflow-hidden rounded-[var(--arena-radius-lg)] border border-[color:var(--arena-border)] bg-[color:var(--arena-surface)] shadow-[var(--arena-shadow)] backdrop-blur-[10px]">
      {children}
    </div>
  );
}
  ...
  return (
    <div className="mx-auto flex h-[calc(100vh-var(--h-navbar)-16px)] w-[min(1500px,calc(100vw-20px))] max-w-full flex-col py-[10px] max-[860px]:w-[min(100vw-12px,100%)]">
      ...
      >
        ...
        >
          <div ref={right.containerRef} className="flex flex-1 min-h-0 flex-col">
            ...
            <div
              ...
              className="flex"
            >
              <div ref={bottom.containerRef} className="flex min-h-0 flex-1">
