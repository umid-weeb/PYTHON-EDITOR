...
def _templates() -> list[TemplateDefinition]:
    ...
    return [
        ...
        TemplateDefinition(
            ...
            build_title=lambda index: "Takrorlarsiz saralash (" + ("o'sish" if index % 2 == 0 else "kamayish") + " tartibida)",
            difficulty="easy",
            tags=["sorting", "array"],
            build_description=lambda index: _problem_description(
                title="Takrorlarsiz saralash (" + ("o'sish" if index % 2 == 0 else "kamayish") + " tartibida)",
                ...
                steps=[
                    ...
                    "Ularni " + ("o'sish" if index % 2 == 0 else "kamayish") + " tartibida qaytaring.",
                ],
                examples=[
            ...
            build_constraints=lambda index: [
                ...
                "-500 <= nums[i] <= 500",
                "Bu variantda " + ("o'sish" if index % 2 == 0 else "kamayish") + " tartibi ishlatiladi.",
            ],
            build_starter_code=lambda index: _starter("nums"),
            build_test_cases=lambda index: _mk_cases(
