...
// --- TOGGLE COMMENT, FORMAT, DUPLICATE, MOVE, FIND, DELETE, SNIPPETS ... same as before ---
...
async function setupSafeExecutionEnvironment() {
  ...
  // --- Infinite loop protection va safe execution ---
  await pyodide.runPythonAsync(`
import sys
import ast
import builtins
...
// --- runCode(), save/load/download/upload, showOutput ... same as before ---
